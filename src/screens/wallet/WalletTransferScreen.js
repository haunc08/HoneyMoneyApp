    ...
    const Item = ({ name, color, money }) => (
      ...
      >
        <Icon
          ...
          color={color}
        />
        <String style={{ marginBottom: 0, fontSize: sizeFactor * 1.25 }}>
          {name}
        </String>
        <String style={{ marginBottom: 0, fontSize: sizeFactor * 1.25 }}>
          {" (" + toMoneyString(money) + ")"}
      ...
      <ScreenView style={{ backgroundColor: "white" }}>
        ...
        >
          ...
          >
            <Row style={{ marginBottom: 0 }}>
              <Item
                name={this.state.nguon.name}
                color={this.state.nguon.color}
                money={this.state.nguon.money}
              />
              {/* <Icon
                name="chevron-right"
                type="material-community"
        ...
        >
          ...
          >
            <Row style={{ marginBottom: 0 }}>
              <Item
                name={this.state.dich.name}
                color={this.state.dich.color}
                money={this.state.dich.money}
              />
              {/* <Icon
                name="chevron-right"
                type="material-community"
